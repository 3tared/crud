...
export const productList: IProdcut[] = [
  {
    id: uuid(),
    title: 'Apple Iphone 9',
    description:
      'An apple mobile which is nothing like apple It is powered by Apple A13 Bionic processor. It is backed by a 2050 mAh battery. The phone runs on iOS v13.',
    colors: ['#000000', '#a855f7', '#645CBB'],
    price: '549',
